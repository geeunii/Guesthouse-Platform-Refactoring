...
**팀명:** 2조 (Team Two) | **프로젝트 유형:** K-Digital Training 최종 프로젝트  
**리팩토링 기간:** 2026.01.10 ~ 2026.01.15 (개인 고도화)  
**담당 파트:** ☁️ 인프라 아키텍처 & 🤖 AI 분석 로직
...
**"데이터가 없는 신규 숙소도 AI 컨설팅을 받을 수 있을까?"** 라는 고민에서 출발했습니다.  
생성형 AI(Google Gemini)를 활용해 숙소 리뷰를 분석하고 운영 솔루션을 제안하는 **B2B 호스트 관리 플랫폼**입니다.  
기존의 모놀리식 구조를 개선하여, **NCP VPC 환경에서 User/Admin 서버를 물리적으로 분리**하고 보안을 강화한 리팩토링 버전입니다.
...
### 1. ☁️ 인프라 아키텍처 설계 (Infra)
- **VPC 네트워크 구축:** Public/Private Subnet 분리하여 DB 및 관리자 서버 보호
